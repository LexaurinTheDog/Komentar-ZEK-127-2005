# Část první, Hlava III, Díly 4–5 — Radiokomunikační účet; správa čísel, číselných řad a kódů, adres a jmen (§§ 27–37)

> **Téma kapitoly:** Hlava III Díl 4 zavádí **radiokomunikační účet** jako mimorozpočtový nástroj financování nákladů vzniklých při reorganizaci rádiového spektra (§ 27). Díl 5 tvoří páteř **správy čísel** pro sítě a služby elektronických komunikací: definuje pojmový základ a povinnosti Úřadu (§ 28), číslovací plány a jejich změny (§ 29), režim oprávnění k využívání čísel — žádost, udělení, obsah, změna, zánik (§§ 30–32), zvláštní povinnosti vázané na čísla tísňové komunikace (§ 33) a harmonizovaná čísla (§ 33a), systém veřejné výstrahy (§ 33b), přenositelnost telefonních čísel (§ 34) a změnu poskytovatele přístupu k internetu (§ 34a), přístup ke všem číslům v rámci EU (§ 35), správní režim změny, odnětí a pozbytí platnosti oprávnění (§ 36) a poplatky za právo využívat čísla (§ 37). Úprava transponuje Evropský kodex pro elektronické komunikace (EECC, směrnice 2018/1972/EU), zejména jeho čl. 93–108. Navazuje na [03-hlava3-dil3-radiove-spektrum.md](03-hlava3-dil3-radiove-spektrum.md) (správa rádiových kmitočtů) a předchází [05-hlava3-dil6-8-ceny-propojeni-pristup.md](05-hlava3-dil6-8-ceny-propojeni-pristup.md) (ceny, propojení, přístup).

---

**Díl 4 — Radiokomunikační účet**

### § 27 — Radiokomunikační účet
...
Anomálie v textu: odst. 3, věta druhá, obsahuje zjevnou chybu zákonné redakce — slovní spojení „oprávněných nároků" je duplicitní (správně: „nároků oprávněných subjektů"); jde o textovou chybu existující ve znění ZEK.

#### Výchozí podmínka pro nárok na kompenzaci (odst. 1)

Nárok na čerpání prostředků radiokomunikačního účtu podle odst. 1 vzniká, jsou-li splněny tři podmínky kumulativně:

1. **Příčina** — změna ve využívání spektra musí být vyvolána důvody taxativně uvedenými odkazem na § 19 odst. 1 písm. a) až c) (tj. harmonizace, koordinace, mezinárodní závazky), § 19 odst. 4 písm. c) a g) nebo § 20 odst. 3. Jiné důvody — zejména dobrovolná technická obnova — nárok nezakládají.
2. **Efektivnost a účelnost nákladů** — zákon kompenzuje jen náklady, které byly vynaloženy efektivně a účelně; toto kritérium hodnotí Úřad na základě účetní evidence, technické dokumentace a prvotních dokladů (odst. 5). Úřad navrženou výši potvrdí nebo stanoví jinou.
3. **Subjekt** — nároky mohou uplatnit jen držitelé oprávnění k využívání rádiových kmitočtů a Ministerstvo obrany; ostatní subjekty (např. uživatelé zařízení bez oprávnění) nároky nemají.

Druhá věta odst. 1 rozšiřuje věcný rozsah o kompenzaci při odstraňování **technické nekompatibility**, která vznikla bez zavinění dotčeného subjektu — tj. jako důsledek vnějšího technického rozvoje, nikoli z důvodu porušení podmínek oprávnění.

#### Nákladový katalog (odst. 6)

Zákon taxativně vymezuje pět kategorií kompenzovatelných nákladů: úpravy zařízení (písm. a), zůstatková cena vyřazeného zařízení (písm. b), náklady na demontáž (písm. c), montáž a zprovoznění náhradního zařízení (písm. d) a náklady na zajištění dotčené služby alternativní cestou po přechodnou dobu (písm. e). Přechodné provozní náklady podle písm. e) jsou pro praxi zvláště citlivé: mohou zahrnovat dočasný pronájem náhradní kapacity nebo zvýšené náklady na přenosová média; zákon je omezuje formulací „po dobu nezbytně nutnou", což Úřad posuzuje případ od případu.

#### Vlastní výdaje Úřadu — limit 25 % (odst. 2 a 3)

Zákon umožňuje, aby prostředky účtu sloužily i k financování správní a technické infrastruktury Úřadu, ovšem s tvrdým stropem: tyto výdaje nesmí v kalendářním roce přesáhnout **25 % zůstatku na účtu za předchozí rok** (odst. 3). Zároveň podmíněnost: Úřad může čerpat tuto část pouze tehdy, pokud by tím nebyla ohrožena prioritní kompenzace nároků držitelů oprávnění a Ministerstva obrany (odst. 3, věta druhá). Zákon tak konstruuje hierarchii pohledávek: primární jsou nároky soukromých subjektů, sekundární jsou správní výdaje Úřadu.

Zákonný výčet způsobilých výdajů Úřadu (odst. 2 písm. a) až d)) je taxativní a zahrnuje výhradně výdaje funkčně svázané se správou spektra: odbornou pomoc při výběrovém řízení pro udělení oprávnění (vazba na § 21, viz [03-hlava3-dil3-radiove-spektrum.md](03-hlava3-dil3-radiove-spektrum.md)), nákup a rozvoj IT a měřicí techniky, realizaci veřejnoprávních smluv s koordinátory spektra a analytické práce.

#### Finanční struktura účtu (odst. 4)

Příjmy tvoří **část poplatků za využívané kmitočty** ve výši stanovené vládou nařízením (odst. 4 in fine ve spojení s odst. 8). Výše podílu poplatků odváděného na radiokomunikační účet tedy není určena zákonem přímo, nýbrž podzákonnou normou — vláda má prostor ji přizpůsobit aktuálním potřebám reorganizací spektra. Zbývající část poplatků za kmitočty plyne do státního rozpočtu.

Úroky z prostředků vedených u banky jsou příjmem státního rozpočtu; bankovní poplatky naopak jsou výdajem státního rozpočtu. Tato symetrie je výrazem toho, že radiokomunikační účet je sice mimorozpočtový, ale státní prostředky — stát na něm nesmí ekonomicky profitovat ani financovat banku z jiných veřejných zdrojů.

#### Transparentnost — výkaz hospodaření (odst. 7)
...
### § 28 — Povinnosti Úřadu (správa čísel)
...
#### Vymezení předmětu správy — legislativní zkratka „čísla"

Odst. 1 zavádí legislativní zkratku **„čísla"** zahrnující čísla, číselné řady, kódy, adresy a jména. Zákon výslovně vylučuje **internetové adresy (IP adresy, doménová jména)**, jejichž správa spadá do kompetence IANA/ICANN a evropského koordinátora RIPE NCC; Úřad do ní nevstupuje. Zákonná výluka je věcně opodstatněná: internetové adresy jsou spravovány globálně podle soukromoprávních pravidel mezinárodních organizací, zatímco telekomunikační čísla jsou přirozená součást národního regulačního prostoru.

Odst. 1 in fine zdůrazňuje, že správa čísel musí být prováděna **v souladu s harmonizačními záměry EU** — zjevná transpozice EECC čl. 93 a násl. Tento požadavek se promítá především do číslovacích plánů (§ 29), do pravidel pro evropská harmonizovaná čísla a do přenositelnosti čísel (§ 34).

Anomálie v textu: odst. 2, věta první, obsahuje gramaticky vadné spojení „provádění jejích změn" — správně má být „provádění jejich změn"; jde o textovou chybu zákona.

#### Obsah správy čísel (odst. 2)

Zákon vymezuje správu čísel jako soubor pěti aktivit: (i) sestavování číslovacích plánů a jejich změny, (ii) udělování oprávnění k využívání čísel, (iii) provádění změn oprávnění, (iv) odnímání oprávnění a (v) evidence a kontrola využívání. Tento výčet odpovídá čl. 93–97 EECC. Správa čísel je tak věcně správou veřejných zdrojů: číslovací prostor je konečný a jeho nevratné přidělení by bránilo efektivnímu využití kapacit. Proto zákon ukládá Úřadu nejen přidělovat, ale i kontrolovat skutečné využívání čísel a neaktivně přidělená čísla odnímat.

#### Veřejná databáze přidělených čísel (odst. 3)
...
#### Číslovací plány jako podzákonná normotvorba

Odst. 4 přenáší stanovení číslovacích plánů na prováděcí právní předpis. Systematicky jde o technicky regulatorní normu, kde podrobnost a dynamika změn vylučuje úpravu přímo zákonem. V praxi jsou číslovací plány pro telefonní sítě vydávány jako opatření obecné povahy nebo vyhlášky Úřadu; obsahují například délku čísla, strukturu geografických a negeografických čísel, čísla pro tísňové služby, číselné řady pro mobilní sítě, čísla s vyjádřenou cenou a evropská harmonizovaná čísla.

#### Mezinárodní závazky a harmonizovaná čísla

Číslovací plány musejí respektovat závazky z mezinárodních smluv (ITU — Mezinárodní telekomunikační unie, zejména Radioregulations a sektorová doporučení ITU-T, viz E.164 pro mezinárodní telefonní číslovací plán) a z členství v EU. Evropská harmonizovaná čísla jsou specifická čísla vyhrazená celoevropsky pro určité typy služeb (typicky čísla začínající 116, např. 116 111 — linka pro ztracené děti, nebo 116 123 — krizová linka). Úřad je povinen zajistit jejich dostupnost.

#### Příhraniční zvláštní režimy (odst. 2)

EECC čl. 93 odst. 5 umožňuje zavedení zvláštních číslování v příhraničních zónách. Odst. 2 přenáší tuto pravomoc Úřadu s povinností informovat uživatele. Jde například o situace, kdy volání v příhraniční oblasti sdílí číslovací strukturu se sousedním státem (historické dohody s Německem, Slovenskem nebo Polskem).
...
>
> *(11) Ke změně držitele oprávnění k využívání čísel může dojít, není-li v rozhodnutí o udělení oprávnění k využívání čísel stanoveno jinak. Změna držitele oprávnění k využívání čísel se uskutečňuje prostřednictvím udělení nového oprávnění k využívání čísel podle § 32 na základě společné žádosti budoucího držitele oprávnění k využívání čísel a dosavadního držitele oprávnění k využívání čísel. Pro vydání nového oprávnění se obdobně použije § 32. Oprávnění dosavadního držitele k využívání čísel pozbyde platnosti dnem nabytí právní moci nového oprávnění k využívání čísel. Tímto není dotčeno využívání čísel jiným podnikatelem na základě jejich přenesení podle § 34.*
>
> *(12) Podání opravného prostředku proti rozhodnutí podle odstavce 5 nemá odkladný účinek.*

**Výklad:**

#### Vyhrazení správy čísel Úřadu — princip unitárního přidělení

Odst. 1 zavádí **princip vyhrazení správy čísel Úřadu**: čísla lze využívat výhradně na základě oprávnění uděleného Úřadem, ledaže právo EU nebo číslovací plán stanoví výjimku, nebo čísla přiděluje přímo ITU (typicky mezinárodní zkrácená volací čísla ICRN). Tento přístup odpovídá čl. 94 EECC: správa číslovacích zdrojů je věcí národních regulačních orgánů, kteří musejí postupovat transparentně, objektivně, přiměřeně a nediskriminačně.

Zákon ukládá Úřadu zajistit dostupnost čísel pro **všechny veřejné i neveřejné sítě** — Úřad tedy nesmí optimalizovat přidělování ve prospěch dominantních operátorů; musí poskytnout čísla i podnikatelům vstupujícím na trh.

#### Okruh oprávněných žadatelů (odst. 2)

Zákon rozlišuje tři okruhy žadatelů:
1. **Podnikatelé zajišťující veřejné sítě nebo poskytující veřejně dostupné služby** (obecná kategorie, nejširší) — mají nárok na udělení oprávnění bez výjimek.
2. **Právnické osoby nepodnikatelé** — mohou získat oprávnění pro čísla připojená k neveřejným sítím a zkrácená čísla (odst. 2, věta druhá); tímto jsou myšleny např. univerzity nebo nemocnice provozující interní telefonní ústředny.
3. **Pro evropská harmonizovaná čísla** — okruh žadatelů se rozšiřuje o právnické osoby, jejichž činnost odpovídá účelu příslušného čísla (např. neziskové organizace provozující krizové linky).

#### Žádost a lhůty pro rozhodnutí (odst. 3–5)

Zákon detailně vymezuje náležitosti žádosti (odst. 3), přičemž zvláštní důraz klade na identifikaci žadatele (odlišný výčet pro podnikající právnické osoby, podnikající fyzické osoby a nepodnikající právnické osoby). Úřad rozhoduje **bezodkladně** — zákon nestanoví obecnou lhůtu, neboť přidělení standardního čísla nevyžaduje komplexní správní posouzení. Pro čísla vyhrazená pro zvláštní účely (typicky čísla s vyjádřenou cenou, čísla s prémiovou sazbou) platí lhůta **3 týdnů** od doručení úplné žádosti. Je-li odvolání podáno, nemá odkladný účinek (odst. 12) — přidělení čísel nemůže být blokováno procesní taktikou.

#### Odepření oprávnění — taxativní a fakultativní důvody (odst. 8 a 9)

Odst. 8 taxativně vymezuje důvody, pro které Úřad **musí** odmítnout: číslovací plán neumožňuje využití, mezinárodní závazky tomu brání, žádost je neúplná, čísla nejsou k dispozici, nebo žadatel nedoložil způsobilost. Odst. 9 přidává **fakultativní** důvod odmítnutí — nedoplatky na pokutách nebo poplatcích; ten Úřad může, ale nemusí aplikovat. Toto rozlišení je procesně důležité: při taxativním důvodu je rozhodnutí o neudělení vázané, při fakultativním má Úřad správní uvážení.

#### Nediskriminace číselných řad (odst. 10)

Povinnost nediskriminace při přístupu k číselným řadám je projevem obecného principu rovného přístupu v telekomunikacích (EECC čl. 61 a násl.): držitel oprávnění nesmí znevýhodňovat jiné operátory, kteří využívají čísla z jeho číselné řady (např. MVNO využívající čísla přidělená hostitelskému operátorovi MNO).

#### Změna držitele oprávnění (odst. 11)
...
#### Čísla zvláštní ekonomické hodnoty — definice a výběrové řízení

Zákon definuje čísla zvláštní ekonomické hodnoty jako čísla **symetrická** (typicky 800 800, 777 777) nebo **lehce zapamatovatelná** (např. 800 123 456). Tato čísla mají pro marketingové účely podniků vysokou hodnotu — jsou snáze sdělitelná zákazníkům, a tedy více žádaná než standardní přidělená čísla.
...
#### Obsah oprávnění — povinné a fakultativní náležitosti

§ 32 odst. 1 stanoví povinné náležitosti oprávnění (taxativní výčet a) až f)), odst. 2 pak fakultativní podmínky, které Úřad **může** (nikoli musí) uložit. Tato struktura odpovídá čl. 94 odst. 2 EECC, který rovněž rozlišuje povinné informace v oprávnění od podmínek ukládaných na základě věcných důvodů.

Zvláštní pozornost zasluhuje odst. 1 písm. c) — označení **služby** včetně požadavků s ní spojených: čísla jsou přidělována účelově, a oprávnění tak váže číslo ke konkrétní kategorii služby (mobilní, pevná, čísla s vyjádřenou cenou apod.). Změna druhu služby vyžaduje změnu oprávnění.

#### Lhůta platnosti oprávnění — podmínka přiměřenosti (odst. 4)

Zákon nestanoví pevnou dobu platnosti, ale ukládá, že musí být **přiměřená dané službě** a v souladu s harmonizačními záměry EU, mezinárodními závazky a bezpečností státu. Tato podmínka dává Úřadu flexibilitu: stabilní a technologicky nezávislé typy čísel (geografická pevná čísla) mohou mít delší dobu platnosti než speciální čísla vyhrazená pro konkrétní harmonizovaný účel. Podmínka bezpečnosti státu umožňuje zkrátit dobu platnosti nebo ji podmínit u čísel využívaných pro kritickou infrastrukturu.
...
#### Rozsah povinnosti tísňové komunikace a její příjemci

§ 33 je jedním z nejrozsáhlejších ustanovení Dílu 5 a transponuje čl. 109 EECC. Povinnost zajistit přístup k tísňovým službám dopadá na **podnikatele poskytující veřejně dostupnou interpersonální komunikační službu založenou na číslech** (odst. 1). Jde tedy zejména o tradiční telefonní operátory, ale i o poskytovatele VoIP, pokud umožňují volání na čísla z národního nebo mezinárodního číslovacího plánu. Zákon explicitně zahrnuje osoby se zdravotním postižením a uživatele veřejných telefonních automatů — z hlediska přístupu k tísni nesmí existovat výjimka.

Tísňová čísla jsou zákonem vyjmenována přímo (112, 150, 155, 158) — tato čísla nelze měnit prováděcím předpisem, nýbrž jen zákonem. Číslovací plán může stanovit další čísla.

#### Lokalizační povinnosti a databáze (odst. 2–5)

Zákon buduje třívrstevnatou architekturu pro lokalizaci:
- **Operátoři pevných sítí** mají povinnost předávat osobní a identifikační údaje účastníků operátorovi zajišťujícímu připojení tísňového centra, a to průběžně s aktualizací minimálně každých 14 dnů (odst. 2).
- **Operátor připojení tísňového centra** vede centrální databázi a zpřístupňuje ji tísňovým centrům dálkově a bezodkladně (odst. 3); náklady mu hradí provozovatel tísňového centra (odst. 4).
- **Mobilní operátoři** mají nejpřísnější povinnost: pro každou tísňovou komunikaci předávají lokalizační údaje (§ 91 ZEK) v reálném čase, a to včetně údajů generovaných samotným zařízením (GPS, Cell-ID) — bez souhlasu účastníka (odst. 5, věta druhá).

Odst. 5, věta druhá vytváří **zákonnou výjimku z požadavku souhlasu** dle GDPR čl. 6 odst. 1 písm. c) (plnění právní povinnosti) — jde o zákonnou povinnost Úřadu, respektive operátora, a tato výjimka je přípustná za podmínek GDPR recitálu 45.

#### Veřejná výstraha — systém Cell Broadcast (odst. 14–15 a § 33b)

Zákon v odst. 14 definuje tísňovou komunikaci jako komunikaci zahrnující volání, SMS a další způsoby dle odst. 15. Rozvoj dalších způsobů (odst. 15) je svěřen spolupráci operátorů, Ministerstva vnitra, Ministerstva zdravotnictví a Úřadu za zohledňování pokynů BEREC — jde o dynamickou referenci na technologický vývoj (technologie Cell Broadcast pro masové výstrahy viz § 33b).

#### Zlomyslná volání — správní blokace (odst. 10–12, 19)

Zákon zavádí zvláštní správní opatření: na žádost provozovatele tísňového centra může operátor zablokovat SIM kartu nebo přístup zařízení, z nějž jsou uskutečňována zlomyslná volání (odst. 10). Odblokování je výlučnou pravomocí Úřadu — tedy správního orgánu, nikoli operátora (odst. 11). Zákon tak konstruuje správní intervenci s dvoustupňovou ochranou: přiměřenost blokace posuzuje Úřad, který přihlíží k závažnosti jednání. Prováděcí předpis stanoví kategorizaci zlomyslné komunikace a podmínky pro podání žádosti o blokaci (odst. 19).

#### Přístup bez datového limitu (odst. 18)
...
#### Evropská harmonizovaná čísla — rozsah povinnosti
...
#### Systém veřejné výstrahy — transpozice EECC čl. 110

§ 33b zavádí povinnost mobilních operátorů zapojit se do systému veřejné výstrahy (Public Warning System, PWS). Povinnost dopadá výhradně na poskytovatele **mobilních** interpersonálních komunikačních služeb — veřejné výstrahy jsou geograficky cílené (Cell Broadcast, SMS) a jejich efektivita závisí na pokrytí mobilní sítě v zasažené oblasti. Pevní operátoři touto povinností zatíženi nejsou.
...
Přenositelnost čísel (Mobile Number Portability, MNP; Fixed Number Portability, FNP) je jedním z klíčových nástrojů ochrany hospodářské soutěže na telekomunikačním trhu. Zákazník, který si oblíbil své číslo a chce změnit operátora, nesmí být nucen k volbě: buď si ponechat číslo (a zůstat u operátora), nebo operátora změnit (a ztratit číslo). Přenositelnost odstraňuje tuto bariéru přechodu. EECC čl. 106 ukládá přenositelnost jako povinnost bez výjimek pro geografická a negeografická čísla.

Zákon definuje v odst. 3 a 4 pojmy geografického a negeografického čísla — toto rozlišení je podstatné pro rozsah přenositelnosti: geografická čísla jsou přenosná jen na **určeném území** (v rámci příslušné geolokality), zatímco negeografická (mobilní, freephone, čísla s vyjádřenou cenou) jsou přenosná **kdekoli na území státu**. Přenositelnost mezi pevnými a mobilními sítěmi je výslovně vyloučena (odst. 2), ledaže prováděcí předpis pro konkrétní kategorie čísel stanoví jinak.

#### Procedura přenesení — vedení procesu přejímajícím operátorem

Zákon od novely implementující EECC zavádí **vedení procesu přejímajícím operátorem** (recipient-led porting): zákazník podá žádost o přenesení čísla **u nového operátora** (přejímající), který pak koordinuje přenos s dosavadním operátorem (opouštěný). Tímto modelem se eliminoval starší model, kde zákazník musel nejprve žádat o uvolnění čísla opouštěného operátora — ten měl přirozený zájem proces prodlužovat.

Klíčové procesní prvky:
- **Ověřovací kód** (odst. 7 písm. d)) — opouštěný operátor vydá zákazníkovi kód, který prokazuje souhlas s přenosem čísla; tím se brání neoprávněnému přenosu.
- **Lhůta 1 pracovního dne** pro aktivaci od dohodnutého data (odst. 13 in fine) — horní hranice výpadku je 1 pracovní den (odst. 6), aktivace musí proběhnout do 1 pracovního dne od dohodnutého data.
- **Záchranná klauzule** (odst. 14): selže-li proces, opouštěný operátor musí obnovit původní číslo a službu za původních podmínek.
- **Zákaz blokace procesu** (odst. 15): operátor sítě, přes niž probíhá přenos, nesmí bránit procesu přenosu — technická blokace je zakázána.

#### Paušální náhrada (odst. 11)

Zákon zakotvuje právo na **paušální náhradu** za zpoždění nebo zneužití přenosu čísla v rozmezí stanoveném zákonem přímo: nejméně 100 Kč/den, nejvýše 1 000 Kč/den. Prováděcí předpis stanoví způsob výpočtu výše v tomto rozmezí. Paušální náhrada nevylučuje právo na náhradu škody dle občanského zákoníku v rozsahu přesahujícím paušál (odst. 11 in fine) — zákon tak zachovává obecnou deliktní odpovědnost jako podpůrný mechanismus. Tímto způsobem zákon vytváří motivační rámec pro operátory: rychlé přenesení čísla je ekonomicky výhodné.

#### Zůstatek předplatného (odst. 10)
...
#### Vztah k přenositelnosti čísel — paralela a rozdíly

§ 34a byl do ZEK doplněn jako transpozice čl. 106 odst. 4 EECC, který rozšiřuje ochranu spotřebitele při změně poskytovatele i na **přístup k internetu** bez vázanosti na telefonní číslo. Zatímco přenositelnost čísel (§ 34) je primárně nástrojem ochrany telefonního čísla jako identifikátoru, § 34a se zaměřuje na **kontinuitu internetového připojení** — tedy na to, aby zákazník při změně ISP nepřišel o přístup k internetu na déle než 1 pracovní den (odst. 8 in fine).

Procedurální struktura § 34a je co nejvíce paralelní s § 34: ověřovací kód vydaný opouštěným poskytovatelem, vedení procesu přejímajícím poskytovatelem, lhůta 1 pracovní den pro vyrozumění opouštěného, paušální náhrada v rozmezí 100–1 000 Kč/den. Technické podmínky jsou delegovány na prováděcí předpis vydaný podle § 34 odst. 5 — zákon tak záměrně sdílí podzákonnou úpravu obou procesů.

#### Podmínka technické proveditelnosti (odst. 1)

Na rozdíl od přenositelnosti čísel, která je bezpodmínečná, kontinuita internetového připojení je podmíněna **technickou proveditelností**. Tato výhrada je věcně opodstatněná: sdílená fyzická infrastruktura (účastnická přípojka ve vlastnictví třetí strany) nemusí technicky umožnit seamless přechod; zákazník v lokalitě bez alternativní infrastruktury objektivně nemůže získat kontinuitu od nového poskytovatele, dokud ten fyzicky nezajistí přípojku.

#### Nediskriminační přístup k switching systémům (odst. 12)
...
#### Přístup ke všem číslům v EU — princip vzájemné dostupnosti

Odst. 1 transponuje čl. 108 EECC: v rámci vnitřního trhu EU mají mít koncoví uživatelé přístup ke všem číslům používaným v EU — ke službám na negeografických číslech jiných členských států i k číslovacím plánům všech členských států. Zákon podmíní tuto povinnost **ekonomickou přiměřeností** — operátor tedy může odmítnout zajistit přístup ke zcela okrajovým číselným prostorům, pokud by to nebylo ekonomicky únosné; je to však výjimka, nikoli pravidlo.

Zákon výslovně zachovává právo volaného účastníka **z obchodních důvodů omezit přístup** z určitých geografických oblastí — typicky zahraniční čísla, která jsou blokována z důvodu ochrany před podvody (premium rate fraud z exotických destinací). Tímto zákon vyvažuje zájem na dostupnosti s legitímními obchodními motivy.

#### Ochrana před podvody na číslech s vyjádřenou cenou (odst. 2–4)

Zákon vytváří třístupňový mechanismus ochrany:
1. **Povinnost informovat** uživatele o ceně (odst. 2, věta první) — ex ante transparentnost;
2. **Automatická hláska** před poskytnutím prémiové služby (odst. 2, věta druhá) — aktivní varování;
...
>
> *- c) dnem úmrtí držitele oprávnění, pokud v jeho podnikání nepokračuje dědic nebo správce pozůstalosti, nebo*
>
...
#### Změna oprávnění — vázaná pravomoc s konzultační povinností

§ 36 odst. 1 stanoví taxativní výčet důvodů pro změnu oprávnění ex officio (písm. a) až c)) a na žádost držitele (písm. d)). U důvodů a) až c) je změna vázanou pravomocí Úřadu — splní-li se podmínky, Úřad musí rozhodnout. U písm. d) jde o věcnou žádost, o níž Úřad rozhoduje správním uvážením.

Zákon důsledně chrání legitimní očekávání držitelů oprávnění: povinná konzultační lhůta 1 měsíce před změnou (s výjimkou krizového stavu a žádosti samotného držitele), zkrácení na minimum 7 dnů pouze při mimořádných okolnostech s povinností odůvodnění.

#### Kompenzace nákladů při vnucené změně (odst. 2)

Analogicky jako u radiokomunikačního účtu (§ 27 odst. 1) zákon zavazuje stát k náhradě nezbytných nákladů vyvolaných změnou oprávnění z důvodu mezinárodních závazků nebo krizového stavu. Výjimka z kompenzace je logická: byl-li žadatel Úřadem upozorněn na plánovanou změnu ještě před udělením oprávnění a tato skutečnost je v rozhodnutí zmíněna, jednal na vlastní riziko.

#### Odnětí — fakultativní a obligatorní důvody (odst. 4 a 5)

Zákon opět rozlišuje **fakultativní odnětí** (odst. 4 — Úřad „je oprávněn") od **obligatorního odnětí** (odst. 5 — Úřad „rozhodne"). Facultativním důvodem je nesplnění podmínek nebo povinností (s předchozím písemným upozorněním a záchrannou lhůtou dle § 114). Zvláštní pravidlo platí pro harmonizovaná čísla (odst. 4 písm. c)): neaktivní využívání po dobu 6 měsíců nebo 12 měsíců v souhrnu v průběhu 2 let je důvodem k odnětí — zákon tak brání spekulativnímu „hoarding" atraktivních čísel bez jejich skutečného využívání.

Po odnětí za nesplnění povinností (odst. 4 písm. b)) platí karenční lhůta 6 měsíců pro nové podání žádosti (odst. 6) — jde o sankční prvek, nikoli trvalou diskvalifikaci.

#### Pozbytí platnosti ze zákona (odst. 7) a povinnost ukončit využívání (odst. 8)
...
#### Povahy poplatku za čísla — veřejnoprávní poplatek za využívání omezeného zdroje

Poplatek za právo využívat čísla je **veřejnoprávní poplatek** za využívání omezeného veřejného zdroje — číslovacího prostoru. Má dvojí funkci: (i) zajistit přiměřenou kompenzaci veřejného sektoru za správu a přidělování čísel a (ii) vytvořit ekonomický tlak na efektivní využívání přidělených čísel (zbytečně přidělená čísla za poplatek nejsou ekonomicky neutrální).

Zákon výslovně osvobozuje **tísňová čísla** od poplatku (odst. 1 in fine) — logicky, neboť tísňová čísla nejsou ekonomicky využívána k obchodním účelům a jejich zpoplatnění by mohlo odradit od zajišťování přístupu k tísňovým službám.
