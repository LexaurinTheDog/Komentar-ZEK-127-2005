# Část první, Hlava III, Díly 6–8 — Univerzální služba, analýza relevantních trhů a podniky s významnou tržní silou, regulace cen (§§ 38–60)

> **Téma kapitoly:** Tato kapitola pokrývá závěr Hlavy III Části první ZEK ve třech navazujících dílech. **Díl 6 (§§ 38–50)** upravuje **univerzální službu** — sociálně korektivní mechanismus zajišťující každému spotřebiteli dostupnost přiměřeného přístupu k internetu a hlasové komunikace v pevném místě za přijatelnou cenu, včetně zvláštních cen pro osoby se zvláštními sociálními potřebami, mechanismu financování z veřejných zdrojů a povinnosti Úřadu pravidelně přezkoumat nezbytnost ukládaných povinností. **Díl 7 (§§ 51–53)** tvoří jádro sektorové ex ante regulace: Úřad (ČTÚ) provádí **analýzy relevantních trhů** v elektronických komunikacích, vymezuje relevantní trhy a na jejich základě **stanoví podniky s významnou tržní silou (SMP)**, jimž ukládá nápravná opatření — povinnosti průhlednosti, nediskriminace, oddělené evidence nákladů, přístupu a regulace cen. Díl 7 harmonizuje české právo s čl. 64–76 **Evropského kodexu pro elektronické komunikace (EECC, směrnice 2018/1972/EU)** a navazuje na Doporučení Komise o relevantních trzích. **Díl 8 (§§ 54–60)** zavádí **regulaci cen** v oblasti elektronických komunikací: vymezuje nákladovou orientaci cen, podmínky pro uplatnění cenové regulace, způsoby regulace (maximální/minimální cena, cenové podmínky, moratorium) a povinnosti SMP podniku prokazovat nákladovou orientaci a soulad s oddělenou evidencí nákladů. Díl 8 je organicky provázán s Dílem 7: regulace cen nastupuje tehdy, kdy opatření uložená na základě analýzy relevantního trhu nepostačují. Kapitola navazuje na problematiku přístupových povinností a propojení upravených v §§ 79–86a (přístup a propojení), odkazuje na [04-hlava3-dil4-5-cisla-univerzalni-sluzba.md](04-hlava3-dil4-5-cisla-univerzalni-sluzba.md) (číslování a předcházející díly) a [06-hlava4-dil1-prava-ucastniku-smlouvy.md](06-hlava4-dil1-prava-ucastniku-smlouvy.md) (práva účastníků).

---

**— DÍL 6: UNIVERZÁLNÍ SLUŽBA (§§ 38–50) —**
...
>
> *d) doplňkové služby k dílčím službám podle písmen a) a b), kterými jsou 1. podrobný rozpis účtů, 2. bezplatné selektivní blokování odchozích volání, textových zpráv nebo multimediálních zpráv, nebo, je-li to technicky proveditelné, jiných podobných aplikací se zvýšenou sazbou, 3. systémy předplatného, 4. postupné splácení ceny za připojení, 5. zvláštní opatření při neplacení účtů, 6. poradenství ohledně sazeb, 7. kontrola nákladů, 8. deaktivace vyúčtování třetích stran.*
>
...
#### Funkce a prameny úpravy

§ 38 je základním ustanovením Dílu 6. Vymezuje **rozsah univerzální služby** jako minimálního souboru komunikačních služeb, k nimž musí mít přístup každý spotřebitel na území státu za přijatelnou cenu. Jde o transpozici čl. 84–107 EECC (směrnice 2018/1972/EU), která nahradila předchozí směrnici o univerzální službě 2002/22/ES (USD). Oproti předchozí úpravě EECC rozšiřuje povinnou složku o **přiměřený přístup k internetu v pevném místě** (odst. 2 písm. a), zatímco tradiční telefonní přípojka (hlasová komunikace, písm. b) zůstává zachována jako samostatná složka.

#### Katalog dílčích služeb (odst. 2)

Zákon taxativně vymezuje čtyři skupiny dílčích služeb: (i) přiměřený přístup k internetu v pevném místě, (ii) přístup k hlasové komunikaci v pevném místě, (iii) rovnocenný přístup osob se zdravotním postižením a (iv) katalog doplňkových služeb (podrobný rozpis účtů, selektivní blokování, systémy předplatného, postupné splácení, zvláštní opatření při neplacení, poradenství ohledně sazeb, kontrola nákladů, deaktivace vyúčtování třetích stran). Formulace „může Úřad uložit" (odst. 2) nese discretion — Úřad ukládá povinnosti jen tehdy, není-li příslušná služba dostupná za tržních podmínek (srov. § 39 odst. 2).

#### Zvláštní ceny pro sociálně potřebné osoby (odst. 3–8)

Odst. 3 zavádí paralelní mechanismus **zvláštních cen** pro osoby se zvláštními sociálními potřebami (definované v odst. 4 jako osoby se zdravotním postižením dle § 43 odst. 4 nebo příjemci dávky státní sociální pomoci se složkou na živobytí a členové jejich domácností). Poskytovatelé, jimž byla uložena povinnost zvláštní ceny poskytovat, mají nárok na náhradu vzniklých ztrát ze státního rozpočtu prostřednictvím Úřadu (§ 48–49). Zákon v odst. 5 zavádí **centrální evidenci příjemců** vedený Úřadem pro zamezení dvojího čerpání; podnikatelé jsou povinni do ní předávat údaje. Ministerstvo práce a sociálních věcí Úřadu sděluje údaje o aktuálním čerpání dávek.

#### Informační povinnost příjemce a provázání s ochranou spotřebitele

Odst. 7 ukládá příjemci zvláštní ceny aktivní povinnost informovat poskytovatele o změnách v podmínkách pro přiznání ceny do 30 dní. Tato povinnost je personální protiváhou nárokového mechanismu a umožňuje správnou aplikaci odst. 5. Blíže k právům a povinnostem spotřebitelů viz [06-hlava4-dil1-prava-ucastniku-smlouvy.md](06-hlava4-dil1-prava-ucastniku-smlouvy.md).

#### Delegace na nařízení vlády
...
> **§ 39**
>
> *(1) Úřad svůj záměr uložit nebo zrušit jednotlivé povinnosti podle § 38 odst. 2 a 3 (dále jen „povinnost poskytovat univerzální službu") na celém území státu nebo na jeho části konzultuje s dotčenými subjekty podle § 130 s přihlédnutím k výsledkům zeměpisného mapování podle § 115a. V oznámení uvede zejména a) dílčí služby včetně jejich rozsahu, jež budou předmětem povinnosti poskytovat univerzální službu, a území, jehož se bude uložení povinnosti poskytovat univerzální službu týkat, b) odůvodnění záměru uložit povinnost poskytovat univerzální službu, c) podmínky, které Úřad zamýšlí stanovit v rámci povinnosti poskytovat univerzální službu.*
>
...
>
> *(4) Kritéria hodnocení žádostí o poskytování univerzální služby stanoví Úřad v souladu se zásadami uvedenými v § 6. Kritéria zahrnují zejména a) finanční, technické a odborné podmínky podnikatele pro poskytování univerzální služby, b) požadavek, aby náklady na poskytování univerzální služby v požadovaném rozsahu a kvalitě byly co nejnižší.*
>
...
#### Procedura uložení povinnosti — tříkroková logika

§ 39 upravuje procesní postup Úřadu při určování poskytovatele univerzální služby v trojkrokovém schématu: (1) **konzultace záměru** (odst. 1), (2) **přezkum tržní dostupnosti** (odst. 2) — neplyne-li povinnost z tržních mechanismů, Úřad vyhlásí výběrové řízení, (3) **výběrové řízení a uložení povinnosti rozhodnutím** (odst. 7–9).

#### Subsidiarita regulatorní intervence (odst. 2)

Klíčovým normativním pravidlem je odst. 2 první věta: Úřad povinnost **neuloží**, zjistí-li, že příslušná dílčí služba je dostupná za tržních podmínek srovnatelných s požadavky ZEK nebo prostřednictvím jiných nástrojů veřejné politiky. Regulace formou uložení povinnosti je tedy ultima ratio — nastupuje jen tehdy, kdy trh sám o sobě potřeby spotřebitelů nezajistí. Tato zásada odpovídá čl. 86 odst. 1 EECC. Úřad musí periodicky (každé 3 roky dle odst. 3) přezkoumat, zda důvody pro uložení povinnosti trvají.

#### Výběrové řízení — quasi-soutěžní mechanismus

Zákon v odst. 4–8 buduje kvazisoutěžní model: kritéria pro hodnocení přihlášek zahrnují zejména finanční, technické a odborné předpoklady a požadavek minimalizace nákladů. Přihláška musí obsahovat konkrétní návrh výpočtu čistých nákladů (odst. 5), čímž zákon propojuje výběrové řízení s mechanismem financování (§ 48). V odst. 11 zákon výslovně odkazuje na ustanovení občanského zákoníku o veřejné soutěži — jde o hodnotnou legislativní techniku subsidiárního využití soukromoprávního institutu v kontextu správního řízení.

#### Náhradní určení podniku SMP (odst. 13)

Selže-li výběrové řízení (žádný přihlašovatel nebo žádný nevyhovuje), Úřad uloží povinnost **podniku s významnou tržní silou** na příslušném trhu. Propojení s Dílem 7 je zde explicitní: SMP status není jen nástrojem ex ante regulace přístupu, ale zakládá i povinnost poskytovat základní komunikační službu v rámci veřejné služby.

#### Ochrana kontinuity při převodu sítě (odst. 15–16)
...
>
> *(2) Službou přiměřeného přístupu k internetu v pevném místě se rozumí pro účely univerzální služby služba, která umožňuje využívat nejméně tyto služby: a) elektronická pošta, b) vyhledávače umožňující vyhledávat a nacházet všechny druhy informací, c) základní on-line nástroje pro odbornou přípravu a vzdělávání, d) on-line noviny nebo zprávy, e) on-line nakupování nebo objednávání zboží nebo služeb, f) hledání zaměstnání a nástroje pro hledání zaměstnání, g) navazování profesních kontaktů, h) internetové bankovnictví, i) využívání služeb elektronické veřejné správy (eGovernment), j) sociální média a zasílání rychlých zpráv (instant messaging), k) volání a videohovory ve standardní kvalitě.*
>
...
#### Minimální funkční standardy „přiměřeného přístupu k internetu"

§ 40 odst. 2 je jedním z nejkonkrétnějších ustanovení ZEK: zákon přímo enumeruje 11 kategorií online služeb, jež musí „přiměřený přístup" umožňovat. Jde o přímou transpozici čl. 84 odst. 3 EECC, který zavazuje členské státy k minimálnímu funkčnímu standardu širokopásmového přístupu. Zahrnutí eGovernmentu (písm. i), internetového bankovnictví (h) a videohovorů ve standardní kvalitě (k) reflektuje digitalizaci veřejných i soukromých služeb a zajišťuje, že ani sociálně znevýhodněné osoby nemohou být od těchto služeb odříznuty.

#### Povinnost vyhovět „přiměřeným požadavkům" — neurčitý právní pojem

Odst. 1 a 3 formulují povinnost vyhovět **přiměřeným požadavkům** spotřebitelů. Neurčitost pojmu „přiměřený požadavek" je záměrná: prováděcí právní předpis (odst. 7) konkretizuje charakteristiky. Úřad při výkonu kontroly posuzuje, zda odmítnutí požadavku bylo odůvodněné (technická neproveditelnost, nepřiměřená vzdálenost), nebo zda šlo o neoprávněné odmítnutí. Důkazní břemeno o nepřiměřenosti požadavku nese poskytovatel.

#### Notifikační povinnost při prodlení (odst. 6)
...
>
> *(2) Poskytovatel univerzální služby podle odstavce 1 je povinen osobám se zdravotním postižením zejména a) pronajmout nebo prodat, požádají-li o to, jedno speciálně vybavené telekomunikační koncové zařízení přiměřené jejich zdravotnímu postižení za cenu standardního telekomunikačního koncového zařízení, a b) nabídnout speciální tarif odpovídající jejich potřebám s ohledem na druh jejich zdravotního postižení; poskytnutí zvláštní ceny podle § 38 odst. 3 se považuje za splnění cenového zvýhodnění v rámci cenových podmínek speciálního tarifu.*
>
...
>
> *(4) Osobami se zdravotním postižením se pro účely tohoto zákona rozumí a) držitel průkazu ZTP z důvodu úplné nebo praktické hluchoty, b) držitel průkazu ZTP/P, c) osoba závislá na pomoci jiné fyzické osoby ve stupni II (středně těžká závislost), stupni III (těžká závislost) nebo stupni IV (úplná závislost) nebo, jde-li o nezletilou osobu, spotřebitel, který o ni osobně pečuje, nebo d) spotřebitel, který vychovává nebo který osobně pečuje o nezletilou osobu, která mu byla svěřena do péče nahrazující péči rodičů na základě rozhodnutí příslušného orgánu a která je držitelem průkazu podle písmene a) nebo b).*

**Výklad:**

#### Katalog osob se zdravotním postižením (odst. 4)

§ 43 odst. 4 zavádí pro účely ZEK vlastní legislativní definici zdravotního postižení, odlišnou od obecné definice v zákoně č. 108/2006 Sb. o sociálních službách. Zákon cílí na čtyři skupiny: (i) osoby zcela nebo prakticky neslyšící (průkaz ZTP — hluchota), (ii) osoby s těžkým zdravotním postižením (průkaz ZTP/P), (iii) osoby závislé na pomoci ve stupních II–IV a pečující o ně a (iv) spotřebitele pečující o svěřené nezletilé s průkazem ZTP nebo ZTP/P. Tato definice je autonomní a nelze ji bez dalšího vztahovat na jiné právní předpisy.

#### Právo na speciální zařízení za standardní cenu (odst. 2 písm. a)

Povinnost poskytnout speciálně vybavené koncové zařízení za cenu standardního zařízení je přímou dotací ve prospěch zdravotně postižených: poskytovatel nese cenový rozdíl, aniž by zákon výslovně stanovoval náhradní mechanismus. Zda mu vzniká nárok na kompenzaci prostřednictvím čistých nákladů (§ 48), je otázka, jíž zákon výslovně neřeší — kompenzace z § 48 se výslovně vztahuje na povinnosti uložené podle § 38 odst. 2, nikoliv výslovně na odst. 2 písm. c) ve spojení s § 43 odst. 2 písm. a).
...
#### Interpretační funkce § 44

§ 44 má převážně **interpretační a definiční** funkci: rozvíjí a zpřesňuje katalog doplňkových služeb z § 38 odst. 2 písm. d). Každý z odstavců 1–8 paralelně odpovídá jednomu z 8 bodů § 38 odst. 2 písm. d). Legislativní technika dvou navazujících paragrafů (výčet v § 38, definice v § 44) je v ZEK opakovaným vzorem.

#### Selektivní blokování — ochrana před premium rate

Odst. 2 definuje selektivní blokování jako bezplatně poskytovanou službu, která umožňuje zamezit volání nebo posílání zpráv na čísla se zvýšenou sazbou. Bezplatnost je výslovně zdůrazněna. Technická podmíněnost formulací „je-li to technicky proveditelné" odráží různorodost technologií přístupu; Úřad nemůže požadovat implementaci funkce, pokud technologie přístupu neumožňuje její nasazení.

#### Kontrola nákladů a bezplatná upozornění (odst. 7)

Odst. 7 zakotvuje povinnost spotřebiteli umožnit **dálkový monitoring nákladů** a bezplatné upozornění při neobvyklém nárůstu spotřeby. Tato povinnost se prolíná s povinnostmi informování spotřebitelů v rámci Hlavy IV (viz [06-hlava4-dil1-prava-ucastniku-smlouvy.md](06-hlava4-dil1-prava-ucastniku-smlouvy.md)) a s obecnou ochranou spotřebitele.

#### Deaktivace vyúčtování třetích stran (odst. 8)
...
#### Monitorovací povinnost Úřadu a meziresorní součinnost (odst. 1)

§ 45 odst. 1 ukládá Úřadu průběžné sledování a vyhodnocování **cenové dostupnosti** univerzální služby v kontextu obecného vývoje spotřebitelských cen, inflace a průměrné mzdy. Jde o kvantitativní benchmarking: Úřad musí mít statistická data o cenách poskytovaných na trhu a porovnávat je s ekonomickou realitou průměrného spotřebitele. Pro naplnění této povinnosti zákon výslovně zakotvuje povinnost součinnosti ze strany čtyř ústředních správních orgánů — Ministerstva průmyslu a obchodu (Ministerstvo v terminologii ZEK), Ministerstva financí, Ministerstva práce a sociálních věcí a Českého statistického úřadu.

#### Jednotné ceny a princip minimální intervence (odst. 2)
...
#### Systém parametrů kvality a výkonnostních cílů

§ 47 zavádí povinný **systém kvality** pro poskytovatele univerzální služby: konkrétní parametry (rychlost připojení, dostupnost služby, lhůty zřízení, apod.) a výkonnostní cíle (KPI) jsou delegovány na prováděcí předpis (odst. 3). Zákon sám nestanoví minimální rychlost přístupu k internetu v pevném místě — tato hodnota se mění s technologickým pokrokem a flexibilní právní úprava na úrovni podzákonné normy odpovídá dynamice odvětví.
...
#### Metoda čistých nákladů — inkrementální model

§ 48 odst. 2 definuje čisté náklady jako **inkrementální rozdíl**: náklady poskytovatele s povinností poskytovat univerzální službu minus náklady, jaké by měl tento poskytovatel bez této povinnosti. Zákon výslovně zahrnuje přiměřenou míru návratnosti investic a ukládá odečíst (i) vyhnutelné náklady a (ii) **tržní výhody** (reputační efekty, rozšíření zákaznické základny, zvýšená viditelnost značky), které poskytovatel z plnění povinnosti čerpá. Tím se zabraňuje přeplacení kompenzace — stát hradí pouze skutečné čisté náklady, nikoli celkové náklady na poskytování služby.

#### Oddělené výpočty pro každou povinnost a zákaz dvojího zaúčtování

Odst. 3 vyžaduje, aby výpočet byl proveden odděleně pro každou dílčí povinnost z § 38 odst. 2 a explicitně zakazuje dvojí zaúčtování nákladů nebo výhod. Tím zákon brání nejběžnějšímu zkreslení při výpočtu čistých nákladů na veřejnou službu, kdy jsou sdílené náklady nebo výhody bezdůvodně přiřazovány vícekrát k různým povinnostem.

#### Procesní rámec — lhůty a nezávislé ověření (odst. 5–6)
...
#### Test neúnosné zátěže jako podmínka kompenzace

§ 49 odst. 2 zavádí klíčový filtr: Úřad hradí čisté náklady pouze tehdy, jsou-li pro poskytovatele **neúnosnou zátěží**. Zákon kritéria neúnosnosti nedefinuje přímo — jsou svěřena prováděcímu právnímu předpisu (§ 48 odst. 7). Test neúnosnosti je transpozicí čl. 90 odst. 1 EECC: kompenzace není automatická, nýbrž podmíněna tím, že uložená povinnost fakticky poškozuje ekonomické zájmy poskytovatele. Tím se zamezuje tržně neodůvodněnému přesunu veřejných prostředků k podnikatelům, u nichž povinnost nezpůsobuje objektivní ztrátu.

#### Lhůta pro výplatu kompenzace — ochrana poskytovatele

Odst. 2 třetí věta stanoví maximální lhůtu pro poukázání částky na 3 měsíce od právní moci rozhodnutí. Tato lhůta chrání poskytovatele před likviditními problémy způsobenými průtahy při výplatě kompenzace.

#### Penalizační mechanismus za neoprávněné čerpání (odst. 4)
...
> **§ 50**
>
> *(1) Úřad uveřejní výroční zprávu za dané zúčtovací období, jejíž součástí je alespoň a) výsledek výpočtu čistých nákladů na splnění jednotlivých povinností uložených v rámci univerzální služby a celkové čisté náklady na poskytování univerzální služby, b) určení tržních výhod, které vznikly poskytovatelům univerzální služby v souvislosti s jejím poskytováním, včetně jejich peněžního vyčíslení, a c) informace o provedených úhradách čistých nákladů.*
>
...
**— DÍL 7: ANALÝZA RELEVANTNÍCH TRHŮ A URČENÍ PODNIKU S VÝZNAMNOU TRŽNÍ SILOU (§§ 51–53) —**
...
>
> *(4) V případě, že Komise vydá změnu doporučení o relevantních trzích produktů a služeb, Úřad provede novou analýzu relevantních trhů do 3 let ode dne vydání tohoto doporučení za předpokladu, že se jedná o trhy, které dosud nebyly Komisi Úřadem oznámeny.*
>
...
>
> *(6) Úřad podle výsledku analýzy relevantního trhu stanoví rozhodnutím podnik s významnou tržní silou a popřípadě mu uloží jednu nebo zároveň několik z následujících povinností a) průhlednosti podle § 82, b) nediskriminace podle § 81, c) oddělené evidence nákladů a výnosů podle § 86, d) přístupu k specifickým síťovým prvkům a přiřazeným prostředkům podle § 84, e) související s regulací cen podle § 56 a 57, nebo f) vyhovět přiměřeným žádostem o přístup k inženýrským stavbám a jejich využívání podle § 84 odst. 2 písm. k). Účastníkem tohoto řízení je pouze podnik, o jehož právech a povinnostech má být rozhodováno.*
>
...
>
> *(14) Stanovil-li Úřad podle odstavce 3 podnik s významnou tržní silou na některém relevantním trhu pro koncové uživatele a dospěl-li po provedení konzultace v souladu s § 130 a 131 k závěru, že nápravy nebude dosaženo uložením povinností podle odstavce 6, je oprávněn tomuto podniku nebo těmto podnikům rozhodnutím zakázat a) neodůvodněné nebo nepřiměřené zvýhodňování některých koncových uživatelů, b) nepřiměřené vzájemné vázání služeb, c) účtování neúměrně vysokých cen, nebo d) bránění vstupu na trh a omezování hospodářské soutěže stanovením predátorských cen.*
>
...
#### Analýza relevantních trhů jako páteř sektorové ex ante regulace

§ 51 je klíčovým ustanovením celého ZEK z hlediska hospodářské regulace. Tvoří procesní mechanismus, jímž Úřad aplikuje ex ante regulaci na elektronické komunikace. Navazuje na čl. 64–76 EECC a na Doporučení Komise o relevantních trzích (naposledy Doporučení 2020/C 97/01). Analýza relevantních trhů je věcně odlišná od analýz prováděných Úřadem pro ochranu hospodářské soutěže (ÚOHS) dle zákona č. 143/2001 Sb. — jde o **ex ante** regulační nástroj v sektorovém zákoně, zatímco soutěžní právo ÚOHS operuje ex post a na základě obecného zákazu narušení hospodářské soutěže.

#### Forma opatření obecné povahy — anomálie v § 51

§ 51 odst. 1 stanoví, že analýzu trhu vydává Úřad jako **opatření obecné povahy** (OOP). Z hlediska správního řádu jde o akt s obecnou platností a konkrétním předmětem. Souběžně však odst. 6 stanoví, že Úřad **rozhodnutím** stanoví podnik s VTS a uloží mu povinnosti — přičemž účastníkem tohoto řízení je pouze dotčený podnik. Dochází tak k formálně zajímavé situaci, kdy OOP (analýza) zakládá podklad pro individuální rozhodnutí (uložení povinnosti) vůči konkrétnímu subjektu. Tato dvoustupňová struktura je záměrnou transpozicí unijního rámce; čl. 66 odst. 4 EECC předpokládá konzultaci výsledků analýzy, která je oddělena od samotného uložení povinnosti.

#### Konzultační povinnost a role ÚOHS (odst. 5)

Výsledky analýzy Úřad konzultuje podle § 130 (národní konzultace) a § 131 (notifikace Komisi a BEREC). Výsledky musí být uveřejněny včetně **stanoviska ÚOHS**. Tím je zajištěna koordinace sektorové regulace se soutěžním právem: ÚOHS je konzultativním orgánem, jehož stanovisko je součástí veřejného záznamu, avšak pro Úřad není závazné. Vztah k soutěžnímu právu je doplňkový, nikoliv hierarchický — odst. 1 výslovně uvádí, že trh není efektivně konkurenční tehdy, kdy **nápravná opatření práva hospodářské soutěže nepostačují**. Regulace ZEK tedy nastupuje jako doplněk soutěžního práva, nikoli jako jeho náhrada.

#### Katalog nápravných opatření (odst. 6) — spojení s Hlavou V

Odst. 6 taxativně uvádí nápravná opatření, která lze podniku SMP uložit na základě analýzy: (a) průhlednost (§ 82), (b) nediskriminace (§ 81), (c) oddělená evidence nákladů a výnosů (§ 86), (d) přístup k síťovým prvkům (§ 84), (e) regulace cen (§ 56 a 57) a (f) přístup k inženýrské infrastruktuře (§ 84 odst. 2 písm. k). Zákon volí katalogický model — Úřad nemůže uložit libovolné povinnosti, nýbrž pouze ty ze zákonného výčtu. Jiné povinnosti (odst. 7) lze uložit výhradně se souhlasem Komise.

#### Funkční separace jako mimořádné opatření (odst. 8)

Odst. 8 zavádí možnost uložit vertikálně integrovanému podniku SMP **funkční separaci** (§ 86a) jako krajní prostředek, jehož uplatnění nastupuje, pokud ostatní povinnosti nepostačují k nápravě tržního selhání. Funkční separace — oddělení provozování přístupové sítě od poskytování maloobchodních služeb — je nástrojem s nejvýznamnějším dopadem na strukturu trhu a odpovídá čl. 77 EECC.

#### Zvláštní zákazy pro maloobchodní trhy (odst. 14) — průnik se soutěžním právem

Na maloobchodních trzích pro koncové uživatele, kde nestačí povinnosti dle odst. 6, může Úřad podniku SMP zakázat (i) nepřiměřené zvýhodňování uživatelů, (ii) vázání služeb, (iii) neúměrně vysoké ceny a (iv) predátorské ceny. Tyto zákazy věcně korespondují se zneužitím dominantního postavení dle čl. 102 SFEU a § 10 zákona č. 143/2001 Sb. — avšak jsou uplatnitelné ex ante rozhodnutím Úřadu, nikoli až ex post na základě zjištěného porušení. Tato duplicita je systémově zdůvodněna: sektorový regulátor může jednat rychleji a předvídatelněji než generální soutěžní orgán.

#### Nadnárodní trhy a koordinace s BEREC (odst. 13, 16)
...
#### Trojkriteriový test pro vymezení regulovatelného relevantního trhu (odst. 3)

§ 52 odst. 3 přebírá přímo tzv. **tří-kriteriový test** z Doporučení Komise a čl. 67 odst. 1 EECC. Trh je způsobilý k ex ante regulaci pouze tehdy, jsou-li kumulativně splněna tři kritéria: (i) **vysoké bariéry vstupu** (strukturální, právní nebo regulační, nikoli přechodné), (ii) **nepřítomnost tendence k efektivní soutěži** v relevantním časovém horizontu, a (iii) **nedostatečnost soutěžního práva** k nápravě selhání. Splnění třetího kritéria zavádí subsidiaritu sektorové regulace vůči soutěžnímu právu — pokud by ÚOHS mohl daný problém řešit efektivně sám, sektorová ex ante regulace by nebyla opodstatněná.

#### Presumpce splnění kritérií pro doporučené trhy (odst. 4)

Odst. 4 zavádí vyvratitelnou domněnku: u trhů zahrnutých do Doporučení Komise se má za to, že trojkriteriový test je splněn, pokud Úřad sám nedospěje k opačnému závěru. Obrácení důkazního břemene ve prospěch regulace odráží logiku unijního rámce: u trhů, které Komise po analýze zařadila do doporučení, existuje presumptivní selhání trhu. Česká praxe ČTÚ obvykle tuto domněnku nechává stát — rozhodnutí o tom, že doporučený trh kritéria nesplňuje, jsou výjimečná.

#### Zeměpisné mapování jako vstupní podklad (odst. 1)
...
>
> *(4) Při posuzování, zda mají 2 nebo více subjektů na relevantním trhu společnou významnou tržní sílu, postupuje Úřad v souladu s pokyny Komise pro analýzu relevantních trhů a posuzování významné tržní síly.*

**Výklad:**

#### Definice SMP — funkční ekvivalent dominantního postavení

§ 53 odst. 1 definuje podnik s **významnou tržní silou (SMP — Significant Market Power)** jako subjekt schopný chovat se ve značné míře nezávisle na konkurenci, zákaznících a spotřebitelích. Tato definice je funkčně ekvivalentní pojmu **dominantního postavení** ve smyslu čl. 102 SFEU a § 10 zákona č. 143/2001 Sb. — jde o onu ustálenou formulaci z rozsudku Soudního dvora EU ve věci *United Brands* (27/76). Zákon tak vědomě odkazuje na rozvinutou doktrínu soutěžního práva, avšak aplikuje ji v ex ante regulačním kontextu: SMP není výsledkem ex post dokazování protiprávního jednání, nýbrž regulatorního určení na základě analýzy trhu.

#### Přenesení tržní síly na úzce související trhy (odst. 2)

Odst. 2 kodifikuje tzv. **leverage theory** — přenesení tržní síly z jednoho trhu na sousední trh. Podmínkou je existence vazeb mezi trhy (vertikální nebo horizontální integrace, sdílená infrastruktura, závislost maloobchodního trhu na velkoobchodním) umožňujících přenesení tržního vlivu. Zákon v § 51 odst. 15 pak na toto ustanovení navazuje a umožňuje uložení regulatorních povinností i na souvisejícím trhu. Propojení s § 51 odst. 15 je explicitní — aplikace leverage theory se tedy odehrává prostřednictvím § 51, nikoliv přímo z § 53.

#### Společná VTS — oligopolní regulace (odst. 3–4)

Odst. 3 umožňuje označit jako SMP více subjektů se **společnou VTS** (collective dominance). Posuzování společné VTS se řídí pokyny Komise, zejména Pokyny pro analýzu relevantních trhů a hodnocení VTS (2018). Společná VTS typicky nastává na oligopolních trzích, kde několik hráčů bez explicitní koordinace (tacit collusion) chová se jako by jednali jako jeden dominantní subjekt. Srovnání s konceptem kolektivní dominance v soutěžním právu EU (*Airtours*, *Laurent Piau* aj.): podmínky pro konstatování jsou v zásadě shodné.

#### Vztah k ÚOHS — paralelní pravomoci
...
### § 54 — Povinnosti podnikatele k uveřejňování cen

> **§ 54**
>
> *Podnikatel poskytující veřejně dostupnou službu elektronických komunikací a poskytovatel univerzální služby je povinen a) uveřejnit ceny služeb a jejich změny, včetně určených podmínek, podle zvláštního právního předpisu před nabytím platnosti těchto cen, a to i způsobem umožňujícím dálkový přístup, a b) předkládat v elektronické podobě platné ceny služeb a jejich změny, včetně určených podmínek bezodkladně na vyžádání Úřadu.*
...
### § 55 — Nákladová orientace cen za propojení
...
#### Definice regulace cen — ceny bez DPH

§ 56 odst. 1 vymezuje regulaci cen jako stanovení nebo přímé usměrňování výše cen bez DPH. Vyloučení DPH ze základu regulace je prakticky odůvodněno: DPH je průchozím daňovým plněním a podnikatel nemá vliv na výši sazby DPH, takže regulace cen zahrnující DPH by regulovala cizí daňové plnění.

#### Dvojí oblast uplatnění regulace cen (odst. 2)

Úřad může regulovat ceny ve dvou oblastech: (i) **ceny za univerzální službu** (bez ohledu na SMP status poskytovatele) a (ii) **ceny SMP podniku** na regulovaném relevantním trhu. V obou případech se regulace provádí **rozhodnutím o ceně**. Regulace cen za univerzální službu je spojena s kontrolou cenové dostupnosti (§ 45); regulace cen SMP podniku je podmíněna analýzou trhu (§ 57).

#### Garance nákladové pokrytosti — ochrana investic regulovaného (odst. 4)
...
#### Dvoustupňová podmíněnost cenové regulace

§ 57 stanoví podmínky, za nichž Úřad může přistoupit k cenové regulaci. Regulace je dvoustupňově podmíněná: (i) **analýzou trhu** musí být prokázána absence efektivní soutěže, a to konkrétně ve formě hrozby nepřiměřených cen (odst. 1: velkoobchodní trhy) nebo obecného selhání maloobchodního trhu (odst. 2), a (ii) **subsidiaritu cenové regulace** vůči ostatním opatřením dle § 51 odst. 6 písm. a)–d) a f) — cenová regulace nastupuje teprve tehdy, pokud opatření jako průhlednost, nediskriminace, oddělená evidence a přístup nevedou k nápravě.
...
> **§ 58**
>
> *(1) Způsoby regulace cen, které je Úřad oprávněn uplatnit za podmínek stanovených v § 57, jsou a) stanovení minimálních nebo maximálních cen, b) usměrňování vývoje cen stanovením podmínek, kterými jsou 1. maximální rozsah možného zvýšení ceny ve vymezeném období, 2. maximální podíl, v němž je možné promítnout do ceny zvýšení cen určených vstupů ve vymezeném období, 3. závazný postup při tvorbě ceny nebo při její kalkulaci, včetně povinnosti nákladové orientace, stanovení efektivně a účelně vynaložených nákladů a přiměřeného zisku, nebo 4. závazný postup při tvorbě cen na souvisejících maloobchodních trzích u vertikálně integrovaného podniku, včetně uložení zákazu stlačování marží a povinnosti zajistit replikovatelnost nabídek, c) časově omezený zákaz zvyšování cen nad dosud platnou úroveň na relevantním trhu (dále jen „cenové moratorium"); cenové moratorium lze stanovit nejdéle na dobu 12 měsíců.*
>
...
#### Katalog nástrojů cenové regulace

§ 58 taxativně vyjmenovává způsoby regulace cen. Katalog zahrnuje tři základní skupiny:

**Skupina a) — přímá cenová regulace:** stanovení minimálních nebo maximálních cen je nejpřímější formou. Minimální cena typicky zabraňuje predátorskému cenování (níže než náklady), maximální cena brání monopolnímu přetlaku (rent extraction). Odst. 2 umožňuje stanovit cenu **benchmarkingem** — porovnáním s cenami srovnatelných trhů jiných členských států, kde soutěž funguje lépe.

**Skupina b) — podmínkové usměrňování cen:** zahrnuje čtyři subtypy: (b.1) price-cap — maximální meziroční nárůst ceny, (b.2) cost-passthrough — maximální přenositelnost nárůstu vstupních nákladů, (b.3) povinnost nákladové orientace jako závazný kalkulační postup, a (b.4) zákaz **stlačování marží (margin squeeze)** a povinnost replikovatelnosti nabídek pro vertikálně integrované SMP podniky. Poslední subtyp je zvláště důležitý: stlačování marží — kdy vertikálně integrovaný operátor nastavuje velkoobchodní ceny tak vysoko, že alternativní operátoři nemohou zákazníkům nabídnout srovnatelnou maloobchodní cenu — je jednou z nejčastějších forem zneužití dominantního postavení v sektoru elektronických komunikací (srov. *Deutsche Telekom AG v. Komise*, C-280/08 P; *TeliaSonera*, C-52/09).

**Skupina c) — cenové moratorium:** časově omezený (max. 12 měsíců) zákaz zvyšování cen. Jde o provizorní opatření určené typicky pro přechodné období po zahájení regulace trhu, než Úřad dokončí sofistikovanější cenové rozhodnutí.

#### Kumulace způsobů (odst. 3)
...
#### Povinné metodologické odůvodnění

§ 59 odst. 1 ukládá Úřadu, aby v odůvodnění rozhodnutí o ceně **uvedl metodu**, která byla podkladem rozhodnutí. Tato povinnost přesahuje obecné požadavky na odůvodnění správního rozhodnutí (§ 68 odst. 3 SŘ) — zákon výslovně vyžaduje, aby metoda výpočtu ceny (LRIC, LRIC+, retail-minus, benchmarking apod.) byla transparentně uvedena. Metodologické odůvodnění umožňuje regulovanému podniku i odvolacímu orgánu (Rozkladová komise ČTÚ, správní soudy) přezkoumat správnost a přiměřenost regulatorního výpočtu. Je současně povinným podkladem pro splnění povinnosti prokazovat nákladovou orientaci dle § 60.
...
#### Přenesení důkazního břemene na regulovaný podnik

§ 60 odst. 1 přenáší na SMP podnik s povinností nákladové orientace cen **důkazní břemeno** při prokazování souladu uplatněných cen s nákladovým základem. Na vyžádání Úřadu je podnik povinen prokázat, že jeho ceny jsou nákladově orientovány a odpovídají metodice oddělené evidence nákladů (§ 86). Toto přenesení důkazního břemene je specifickým rysem sektorové regulace: na rozdíl od soutěžního práva, kde Komise nebo ÚOHS nesou důkazní břemeno při prokázání porušení, ZEK ukládá aktivní povinnost prokazovat soulad.

#### Nezávislý přezkum nákladů Úřadem

Odst. 1 druhá věta opravňuje Úřad použít metody **nezávislé na metodách podniku**: Úřad tedy není vázán kalkulačním modelem regulovaného podniku a může provádět vlastní výpočet (top-down LRIC, bottom-up LRIC) nebo použít benchmarking vůči srovnatelným trhům. Tím se předchází tzv. regulatory capture prostřednictvím informační asymetrie.
...
*Konec Části první, Hlavy III, Díly 6–8.*
