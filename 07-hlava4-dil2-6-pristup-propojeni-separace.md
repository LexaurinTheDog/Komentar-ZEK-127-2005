# Část první, Hlava IV — Přístup, propojení sítí, sdílení infrastruktury a oddělená evidence (§§ 78–86e)

> **Téma kapitoly:** Tato kapitola pokrývá **Díly 4–6 Hlavy IV** zákona o elektronických komunikacích, které tvoří regulatorní jádro velkoobchodního trhu: Díl 4 (§§ 78–85a) definuje pojmy *přístupu* a *propojení*, upravuje podmínky sjednávání a vymáhání přístupových smluv, povinnosti transparentnosti, podmínky zpřístupnění účastnického vedení a sdílení infrastruktury včetně pasivní infrastruktury (provázání se směrnicí 2014/61/EU o snižování nákladů na vysokorychlostní sítě) a zavádí mechanismus závazných nabídek společných investic do sítí s velmi vysokou kapacitou (VHCN); Díl 5 (§ 86) stanoví povinnost oddělené evidence nákladů a výnosů jako kontrolní nástroj regulace cen; Díl 6 (§§ 86a–86e) upravuje funkční a dobrovolnou separaci vertikálně integrovaných podniků s VTS, zavádí mechanismus závazků a postup při vyřazování starší infrastruktury z provozu. Celá Hlava IV tvoří systémový celek s Dílem 1 (práva účastníků) upraveným v [06-hlava4-dil1-prava-ucastniku-smlouvy.md](06-hlava4-dil1-prava-ucastniku-smlouvy.md) a věcně předchází ochraně údajů v [08-hlava5-ochrana-udaju-soukromi.md](08-hlava5-ochrana-udaju-soukromi.md).

---

**Díl 4 — Propojení a přístup k sítím elektronických komunikací a přiřazeným prostředkům**

### § 78 — Definice přístupu a propojení
...
#### Přístup jako právní institut a jeho taxativní výčet (odst. 1)

Zákon vychází z terminologie harmonizačního rámce EU (směrnice 2002/19/ES o přístupu, nově nahrazena Evropským kodexem elektronických komunikací — směrnicí 2018/1972/EU, jež byla transponována novelou ZEK č. 374/2021 Sb.). Pojem „přístup" je záměrně vymezen široce: zahrnuje nejen fyzické zpřístupnění vedení nebo stožárů (písm. b), ale i programové systémy (písm. c), číselné prostředky (písm. d), roaming (písm. e), podmíněný přístup k placenému vysílání (písm. f) a virtuální sítě (písm. g). Přístup může být poskytován výlučně (exkluzivně) nebo nevýlučně; v regulovaném prostředí jde zpravidla o přístup nevýlučný, protože Úřad může přístup uložit více žadatelům současně.

Výčet v písm. a)–i) je demonstrativní („zejména"), nikoli taxativní. Zahrnuje fyzickou infrastrukturu dle písm. b) ve shodě s čl. 2 bod 2 směrnice 2014/61/EU (fyzická infrastruktura jako každý prvek sítě určený k umístění dalších prvků sítě) — tím se § 78 stává průsečíkem dvou regulatorních vrstev: telekomunikační a stavebně-infrastrukturní.

#### Propojení jako zvláštní druh přístupu (odst. 2–3)

Propojení (interconnection) se odlišuje od přístupu tím, že: (i) spojuje dvě *veřejné* sítě (nikoli síť s individuálním zařízením), (ii) bodem přístupu je vždy propojovací bod (Point of Interconnection, PoI) a (iii) smlouvu uzavírají operátoři navzájem, nikoliv operátor vůči podnikateli na navazujícím trhu. Odst. 3 výslovně vyjadřuje subsidiaritu pojmů: propojení = přístup + specifikum veřejnosti obou sítí. Toto rozlišení má praktický dopad na formulaci smluv a na rozhodovací praxi ČTÚ při řešení sporů dle § 127.

Nepřímé propojení (transite interconnection) prostřednictvím třetí sítě reflektuje realitu národního i mezinárodního tranzitu hovorů — zejména relevantní pro hlasový tranzit a roaming v sítích MVNO.

#### Účastnické vedení — „poslední míle" (odst. 4)
...
#### Obecná povinnost nabídnout propojení (odst. 1)

Odst. 1 zakládá **symetrickou** povinnost: každý operátor veřejné sítě *musí* na žádost jiného oznámeného podnikatele propojení nabídnout a sjednat. Povinnost platí bez ohledu na tržní postavení operátora — je tedy odlišná od asymetrických povinností ukládaných jen podnikům s VTS (§§ 81–85). Podmínkou aktivní legitimace žadatele je oznámení podnikání dle § 13. Smluvní podmínky musí být slučitelné s povinnostmi regulatorně uloženými — odst. 1 tak vytváří zákonnou vázanost obsahu smlouvy na soubor regulatorních povinností.

#### Pravomoci Úřadu mimo rámec VTS (odst. 2)

Odst. 2 umožňuje Úřadu zasáhnout i vůči podnikatelům, kteří nejsou podniky s VTS, pokud je to v odůvodněných případech nezbytné. Typickými scénáři jsou:

- **písm. a)** — zajištění end-to-end konektivity: Úřad může uložit povinnost propojení sítí pro zajištění, aby se volání od jednoho koncového uživatele dostalo k jinému bez přerušení (nástroj používaný zejména v MVNO scénářích nebo při bilaterálních odmítnutích propojení);
- **písm. b)** — přístup k API a EPG: relevantní pro provozovatele multiplexů DTT a operátory kabelových platforem, kteří mohou fakticky uzavřít přístup k interaktivním televizním službám;
- **písm. d)** — interoperabilita OTT komunikačních služeb (aplikace typu Skype, WhatsApp, Signal). Tato povinnost je zcela nová, zavedena transpozicí EECC 2018. Její uložení je podmíněno dvojí zábranou: kromě splnění podmínky v písm. a) je nezbytné formální rozhodnutí Komise dle písm. b) — zákonodárce tak záměrně vyloučil unilaterální národní aktivismus.
...
>
> *(3) Úřad rovněž zohlední při ukládání povinnosti podle odstavce 1*
>
...
#### Systematika § 79a — sdílení fyzické infrastruktury jako více-vrstvý mechanismus

Ustanovení § 79a tvoří nejkomplexnější regulatorní nástroj fyzického sdílení v ZEK. Lze jej rozčlenit do tří funkčních bloků:

**Blok A — sdílení pasivní infrastruktury a lokální roaming (odst. 1–4):** Podmínkou pro uložení povinnosti je trojí splnění: (i) neexistence alternativních přístupových prostředků za férových podmínek, (ii) přímá nezbytnost pro místní spektrové služby a (iii) explicitní zakotvení možnosti sdílení v přídělovém rozhodnutí ČTÚ (kmitočtová licence). Odst. 4 je pozoruhodný tím, že Úřad může v rámci řešení sporu uložit sdílení rádiového spektra — jde o instrumentarium řešení sporů s věcnými důsledky pro frekvenční řízení, překračující standardní rozhodovací praxis.

**Blok B — sdílení přiřazených prostředků a kabelových rozvodů v budovách (odst. 6–7):** Odst. 6 propojuje sdílení s věcněprávním oprávněním k využití cizí nemovitosti dle § 104 ZEK. Sdílení infrastruktury umístěné na cizích pozemcích je podmíněno ekologickými, zdravotními, bezpečnostními nebo územně-plánovacími důvody, které vylučují paralelní výstavbu — je tedy nástrojem *forced co-location* odůvodněné veřejným zájmem. Odst. 7 transponuje čl. 57–61 EECC a koresponduje se směrnicí 2014/61/EU o snižování nákladů na výstavbu sítí s velmi vysokou kapacitou: sdílení kabelových rozvodů v budovách a za prvním soustřeďovacím bodem eliminuje potřebu duplicitní pokládky vedení v objektech. Povinnost lze uložit i vůči vlastníkovi kabelového rozvodu, který sám veřejnou síť nezajišťuje (např. správce nemovitostí). Náklady sdílení se dělí podle rozhodnutí Úřadu, pokud se strany nedohodnou — včetně nákladů vloženého kapitálu a rizikové prémie investora.

**Blok C — přístup za první soustřeďovací bod (odst. 8–10):** Odst. 8 jde nejdál: umožňuje uložit povinnost přístupu za první soustřeďovací uzel až po bod zajišťující komerčně životaschopný počet přípojek. Zabraňuje tak úniku do architektur, kde operátor s VTS provede co-location jen na jediném uzlu s minimální kapacitou. Tři bezpečnostní zábrany v odst. 9 — alternativní VHCN přístup, otevřená nabídka VHCN přístupu a riziko narušení zavádění nových sítí — ochrání inovativní projekty a malé regionální operátory před regulatorní expropriací jejich investic.

#### Vazba na směrnici 2014/61/EU
...
#### Notifikační povinnost a průhlednost (odst. 4)

Povinnost předat smlouvu Úřadu do 10 dnů od uzavření slouží regulatorní transparentnosti: Úřad shromažďuje srovnávací databázi podmínek přístupu a může ji využít při analýzách trhů nebo při rozhodování sporů dle § 127. Přestože zákon nestanoví sankci za prodlení výslovně, jde o povinnost, jejíž porušení může vést k sankci dle § 118 za neplnění uložených podmínek všeobecného oprávnění.

#### Povinné zdůvodnění odmítnutí a dvojitá notifikace (odst. 5)

Odmítnutí smlouvy nelze provést bez věcného odůvodnění: zákon taxativně vymezuje kategorie důvodů (technické, ekonomické, organizační, ostatní). Odmítnutí se oznamuje současně odmítnutému podnikateli i Úřadu — dvojí notifikace je nástrojem regulatorní kontroly, který předchází strategickým odmítnutím bez legitimního důvodu.

#### Dvouměsíční lhůta a rozhodčí pravomoc Úřadu (odst. 7)
...
#### Ekvivalence jako materiální nediskriminace (odst. 1)

Povinnost nediskriminace formulovaná v odst. 1 je přísná: jde o povinnost *věcné* rovnosti podmínek (Equivalence of Inputs, EoI), nikoliv jen formálního zákazu rozlišování. Podnik s VTS musí svým interním útvarům i externím žadatelům o přístup poskytovat *totožné* podmínky — stejné ceny, stejné lhůty, stejnou kvalitu SLA. Rozlišení je dovoleno jen tehdy, jsou-li podmínky objektivně odlišné (jiná kapacita, jiné technické parametry, jiná geografická oblast). Judikatura Soudního dvora EU (věc C-192/08 TeliaSonera Svenska) potvrzuje, že cenový squeeze — kdy maloobchodní cena podniku s VTS nedosahuje nákladů vstupu pro alternativního operátora — je porušením ekvivalence i bez formální diskriminace.
...
#### Transparentnost jako základní regulatorní nástroj

Povinnost transparentnosti dle § 82 odst. 1 slouží dvěma účelům: (i) umožňuje alternativním operátorům posoudit soulad nabídky s povinnostmi uloženými Úřadem bez nutnosti individuálního vyjednávání a (ii) poskytuje Úřadu auditní stopu pro kontrolu plnění povinností. Zveřejňované informace zahrnují i „podmínky omezující přístup ke službám a aplikacím" — přímá transpozice net neutrality prvků z nařízení 2015/2120/EU (nařízení o otevřeném internetu), která se prolíná do velkoobchodní regulace.
...
#### Brána (Conditional Access System) a přenosová neutralita (odst. 3–5)

Systém podmíněného přístupu (CAS) je technologickým strážcem placeného televizního trhu. Odst. 4 stanoví technologicky neutrální požadavek: brána musí umožnit lokálním a regionálním distribučním operátorům plnou kontrolu nad šířením signálů. Tím se zabraňuje vertikálnímu uzavření trhu provozovateli celoplošných multiplexů, kteří by jinak mohli diskriminovat regionální operátory.

Odst. 5 zavádí přímou povinnost FAIR, REASONABLE AND NON-DISCRIMINATORY (FRAND) podmínek pro poskytovatele šíření chráněného obsahu. Tato povinnost existuje nezávisle na výsledku analýzy trhu — jde o ex ante symetrickou povinnost odůvodněnou strukturou trhu (závislost provozovatelů vysílání na jediném kanálu distribuce).

#### Deregulace a podmínky jejího uplatnění (odst. 6)

Možnost Úřadu zrušit povinnosti podmíněná zjištěním, že žádný subjekt nemá VTS, je podřízena dvěma kumulativním podmínkám: neovlivnění přístupu koncových uživatelů k must-carry kanálům (§ 72) a ochrana soutěže na trhu CAS. Jde o příklad regulatorní flexibility: zákon umožňuje odlehčení regulace, ale zároveň chrání výsledek — dostupnost vysílání a fungující soutěž.
...
#### Katalog přístupových povinností (odst. 2)

Odst. 2 obsahuje jeden z nejrozsáhlejších katalogů přístupových povinností v evropské telekomunikační legislativě. Z hlediska systematiky lze povinnosti třídit:

| Skupina | Povinnosti | Charakter |
|---|---|---|
| Fyzický přístup | písm. a), f), k) | přístup k vedení, co-location, inženýrské stavby |
| Virtuální přístup | písm. b), e), g) | aktivní prvky, rozhraní, roaming |
| Provozní kontinuita | písm. c) | zákaz jednostranného zrušení přístupu |
| Přeprodej | písm. d) | wholesale resale |
| Softwarová integrace | písm. h) | OSS/BSS systémy |
| Propojení | písm. i) | sítě a zařízení |
| Podpůrné služby | písm. j) | assoc. services |

Povinnost dle písm. k) — přístup k inženýrským stavbám — je výslovně odtžena od podmínky příslušnosti aktiva k relevantnímu trhu. Zákonodárce tím eliminoval obrannou argumentaci, že kabelovody nebo vstupní šachty nejsou součástí analýzou vymezeného trhu, a přesto jejich zpřístupnění nelze požadovat.

#### Odmítnutí přístupu a souhlas Úřadu (odst. 6–7)

Mechanismus ex post souhlasu Úřadu s odmítnutím je unikátní: operátor s VTS může odmítnout, ale musí do 15 pracovních dnů od odmítnutí zažádat Úřad o souhlas a zdůvodnit jej. Marné uplynutí lhůty pro vydání rozhodnutí Úřadem se v zákoně výslovně konvertuje na fikci souhlasu — jde o lex specialis k obecné úpravě nečinnosti dle § 80 správního řádu, která zrychluje regulatorní řízení v situacích, kdy jsou technické důvody odmítnutí prima facie legitimní.

#### Proporcionální přístup a test alternativ (odst. 5)
...
#### LLU jako soutěžní páteř pevné sítě

Ustanovení § 85 je institucionálním základem Local Loop Unbundling (LLU) v českém právu. Zákon rozlišuje tři přístupové modality:

| Modalita | Obsah | Technická specifikace |
|---|---|---|
| **Plné zpřístupnění** (Full LLU) | přístup k celé kapacitě vedení | xDSL technologie celé šíře pásma; nástupce: optické vlákno GPON |
| **Sdílený přístup** (Shared LLU) | přístup k části kmitočtu | datová část (ADSL) při zachování hlasové části telco operátorem |
| **Přístup k úseku** (sub-loop) | část vedení ke koncentrátoru nebo mezilehlému bodu | typicky přístup k poslednímu D-slamu nebo optickému uzlu |

Povinnost zpřístupnit vedení je regulatorní povinností ukládanou individuálním rozhodnutím Úřadu po analýze relevantního trhu (trh č. 3a dle Doporučení Komise 2014/710/EU — přístup k místní smyčce). V ČR byl donucen zpřístupnit vedení výhradně incumbent O2 Czech Republic a.s. (nyní CETIN a.s. jako jeho nástupce v oblasti přístupové infrastruktury).
...
#### Regulatorní prázdniny výměnou za otevřenou spolupráci

§ 85a zavádí mechanismus tzv. „regulatory holiday" — dočasného osvobození od povinností dle § 51 výměnou za splnění podmínek otevřené nabídky společných investic. Jde o klíčový podnět pro investice do sítí FTTH/FTTB: provozovatel s VTS investuje do nové optické infrastruktury a výměnou za to získá regulatorní prostor chráněný před ex ante přístupovými povinnostmi — pokud uzavřel alespoň jednu dohodu o spoluinvestici s jiným operátorem na otevřených podmínkách (odst. 3).

Podmínky v odst. 2 písm. a)–e) jsou kumulativní a přísné: nabídka musí být celoživotní (celá provozní životnost sítě), otevřená kdykoli, nediskriminační, transparentní, musí splňovat přílohu č. 2 ZEK a být učiněna v dobré víře. Záměrně zahrnutá flexibilita vstupů (písm. b) bod 2 a 3) umožňuje postupné spoluinvestice — přirozeně odráží postupné nasazení FTTH, kde zájem o spoluinvestici stoupá se zralostí trhu.
...
>
> *(4) Subjekt uvedený v odstavcích 1 a 2 je povinen předložit výsledky oddělené evidence nákladů a výnosů k ověření shody s metodikou uvedenou v opatření vydaném podle odstavce 3 nezávislému kvalifikovanému subjektu do 1 měsíce po uveřejnění své účetní závěrky a závěry ověřování uveřejnit.*
>
...
#### Oddělená evidence jako nástroj cenové regulace

Povinnost oddělené evidence nákladů a výnosů (Regulatory Accounting, RA) plní dvojí funkci: (i) umožňuje Úřadu ověřit, zda regulované ceny odpovídají skutečným nákladům a zda nedochází ke křížovému financování regulovaných aktivit z neregulovatelných zdrojů, a (ii) poskytuje podklad pro výpočet nákladů čistého zatížení poskytovatele univerzální služby (§ 40 ZEK). Metodiku stanoví Úřad opatřením obecné povahy — zákonodárce volí tento normativní nástroj, nikoli vyhlášku, aby metodika mohla být pružněji aktualizována.

#### Nezávislý auditor a publikační povinnost (odst. 4)

Výsledky RA musí být ověřeny nezávislým kvalifikovaným subjektem — zpravidla auditorem. Lhůta jednoho měsíce od zveřejnění účetní závěrky je přísná: u velkých operátorů s VTS, jejichž účetní závěrka je zveřejňována v průběhu druhého čtvrtletí roku, jsou výsledky RA k dispozici nejpozději koncem třetího čtvrtletí. Povinnost zveřejnění závěrů ověřování — nikoli celé zprávy — umožňuje zachovat obchodní tajemství při zachování transparentnosti pro trh.

#### Zvláštní povinnosti pro subjekty s výhradními právy v jiných odvětvích (odst. 8)
...
#### Funkční separace jako ultima ratio regulace

Funkční separace (Functional Separation, FS) je nejpřísnějším regulatorním nástrojem v ZEK krátkým reálného vyvlastnění nebo strukturální separace. Jde o povinnost organizační a operační izolace velkoobchodní divize od maloobchodní, bez změny vlastnické struktury. Zákonodárce ji záměrně podmínil trojím souhlasem: (i) splnění podmínek dle § 51 odst. 7 (tj. selhání všech ostatních nápravných opatření), (ii) schválení Komisí a (iii) koordinovaná analýza trhů po schválení. Tím se FS stává nástrojem, jenž musí být jak vnitrostátně, tak unijně odůvodněn — v EU do roku 2024 nebyla FS v oblasti elektronických komunikací uložena povinně v žádném členském státě.

#### Oddělená hospodářská jednotka a EoI (odst. 3)
...
#### Voluntární separace jako korporátní restrukturalizace s regulatorními důsledky

§ 86b reguluje situaci, kdy operátor s VTS sám rozhodne o oddělení přístupové sítě — buď prodejem na jinou právnickou osobu (strukturální separace), nebo dobrovolnou funkční separací prostřednictvím nové entity. Příkladem je dobrovolná separace britského BT Group, která vyčlenila přístupovou infrastrukturu do Openreach (fakticky formalizována závaznými závazky z roku 2017, v ČR pak paralela v dobrovolném funkčním oddělení CETIN od O2 Czech Republic v roce 2016, ač formálně jde o strukturální separaci).
...
#### Závazky jako soutěžně-regulatorní hybrid

§ 86c zavádí mechanismus závazků, který je strukturálně analogický k závazkům v soutěžním právu dle čl. 9 nařízení Rady (ES) č. 1/2003 nebo § 7 odst. 3 ZOHS. Klíčový rozdíl: závazky v § 86c nejsou reakcí na zahájené správní řízení, ale *preventivním* nabídkovým nástrojem, kterým operátor s VTS může regulatorně „zakotvit" svoji politiku přístupu a získat regulatorní jistotu.

#### Tržní test jako legitimizační proces (odst. 3)

Veřejná konzultace při posuzování závazků umožňuje trhu (alternativní operátoři, potenciální spoluinvestoři) vyjádřit se k dostatečnosti podmínek. Tím se snižuje informační asymetrie Úřadu: regulátor nezná ex ante přiměřenost podmínek lépe než trh, a tak tržní test legitimizuje jeho rozhodnutí o závaznosti. Připomínky třetích stran jsou formálně relevantní pro rozhodnutí, ale zákon nestanoví jejich závaznost pro Úřad.

#### Minimální délka závaznosti u spoluinvestic (odst. 6)
...
#### Wholesale-only operátor jako nová regulatorní kategorie

§ 86d zavádí specifický regulatorní režim pro čistě velkoobchodní operátory (wholesale-only, WO), kteří nemají vlastní maloobchodní zákazníky. V EU tato kategorie vznikla v reakci na vznik oddělených přístupových entit (Openreach UK, CETIN v ČR) a investičních velkoobchodních sítí financovaných státem nebo fondy soukromého kapitálu.

Ratio legis je zřejmé: pokud operátor sám nemá maloobchodní zákazníky, neexistuje riziko vertikálního stlačení marže (margin squeeze) ani diskriminace vlastní divize versus externích klientů — tedy nejsou dány důvody pro povinnosti § 84 odst. 2 písm. k) (přístup k inženýrským stavbám) ani pro plnou sadu asymetrických povinností. Zákon proto umožňuje omezený katalog povinností (§ 81, § 84 odst. 1–4 bez písm. k), eventuelně cenová regulace).

#### Notifikační povinnost a průběžný přezkum (odst. 4–5)
...
#### Regulace migrace — zánik regulačního objektu

§ 86e řeší doposud v telekomunikačním právu neřešenou situaci: co se stane s regulatorními povinnostmi, když regulační objekt (měděná síť, ADSL infrastruktura) přestane existovat? Zákonodárce navazuje na čl. 81 EECC a vytváří dvoustupňový mechanismus:

**Stupeň 1 — migrační závazky (odst. 1–2):** Operátor s VTS musí (i) ohlásit vyřazení „v dostatečném časovém předstihu" — zákon neurčuje minimální délku, praxe v EU ukazuje 5 let jako standardní horizon — a (ii) zajistit alternativní produkty srovnatelné kvality na modernizované síti. Transparentní harmonogram musí zahrnovat výpovědní lhůty dostatečné pro přechod alternativních operátorů bez přerušení jejich vlastních zákazníků. V ČR byl tento mechanismus aktivován v souvislosti s vypínáním ISDN a PSTN sítě operátora CETIN — Úřad ukládá povinnost migračního plánu s minimálně dvouletým přechodným obdobím.

**Stupeň 2 — zánik regulačních povinností (odst. 3):** Po splnění migračních podmínek může Úřad zrušit povinnosti vztahující se k původní infrastruktuře. Podmínky jsou kumulativní: (a) prokazatelné alternativy srovnatelné kvality a (b) dodržení oznámeného procesu. Zákon explicitně nezrušuje povinnosti automaticky — Úřad musí vydat formální rozhodnutí po konzultaci. Odst. 4 pak potvrzuje, že nová infrastruktura bude nadále podléhat regulaci dle § 51, pokud bude zařazena do regulovaných produktů — kontinuita regulace tedy není přerušena, jen přesunuta na nový objekt.
